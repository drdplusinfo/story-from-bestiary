...
class YamlReader extends StrictObject implements \ArrayAccess
{
    ...
    /**
     * @return array
     * @throws \DrdPlus\RulesSkeleton\Exceptions\CanNotReadYamlFile
     * @throws \DrdPlus\RulesSkeleton\Exceptions\CanNotParseYamlFile
     */
     ...
     * @param mixed $offset
     * @param mixed $value
     * @throws \DrdPlus\RulesSkeleton\Exceptions\YamlObjectContentIsReadOnly
     */
